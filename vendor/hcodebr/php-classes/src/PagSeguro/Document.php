...
// Validação de documentos e Tags do documents
...
class Document
{
    ...
    {
        if (!$value) throw new Exception("Informe o valor do documento");

        switch ($type) 
        {
            case Document::CPF:
                if (!Document::isValidCPF($value)) throw new Exception("CPF inválido.");
                break;
        }
