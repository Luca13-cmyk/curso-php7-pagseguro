...
class Address
{
    ...
    public function __construct(
        ...
        string $country)
    {
        if (!$street) throw new Exception("Informe o logradouro do endereço.");
        if (!$number) throw new Exception("Informe o número do endereço.");
        if (!$district) throw new Exception("Informe o bairro do endereço.");
        if (!$postalCode) throw new Exception("Informe o CEP do endereço.");
        if (!$city) throw new Exception("Informe a cidade do endereço.");
        if (!$state) throw new Exception("Informe o estado do endereço.");
        if (!$country) throw new Exception("Informe o país do endereço.");
