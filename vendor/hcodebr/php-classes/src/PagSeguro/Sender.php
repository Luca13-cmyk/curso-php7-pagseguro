...
class Sender
{
        ...
        string $hash)
    {
        ...
        if (!filter_var($email, FILTER_VALIDATE_EMAIL)) throw new Exception("O e-mail informado não é válido.");
        if (!$hash) throw new Exception("Informe a identificação do comprador.");
