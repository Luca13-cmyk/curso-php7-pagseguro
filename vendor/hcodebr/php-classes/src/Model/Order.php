...
class Order extends Model {
	...
	public function getAddress():Address // a funcao retorna a classe Address
	{
		$address = new Address();
	...
	public function setPagSeguroTransactionResponse(
		string $descode, // Codigo do PagSeguro da transacao
		float $vlgrossamount, // Valor Total com Frete
		float $vldiscountamount, // Valor de desconto
		float $vlfeeamount,  // Taxa
		float $vlnetamount, // Valor líquido
		float $extraamount, // Valor extra
		string $despaymentlink = "" // Valor do link do boleto ou debito
		)
	{
		$sql = new Sql();

		$sql->query("
		CALL sp_orderspagseguro_save(:idorder, :descode, :vlgrossamount, :vldiscountamount, :vlfeeamount, :vlnetamount, :extraamount, :despaymentlink)", [
			':idorder'=>$this->getidorder(),
			':descode'=>$descode,
